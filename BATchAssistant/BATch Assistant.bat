...
echo º 1) Wander Gielinor          º
echo.º                             º
echo º 2) Weapon Shop              º
echo.º                             º
echo º 3) Armor Shop               º
echo.º                             º
echo º 4) Legend's Store           º
echo.º                             º
echo º 5) Trading Post             º
echo.º                             º
echo º 6) Max's Shop               º
echo.º                             º
echo º 7) Smuggler                 º
echo.º                             º
echo º 8) The Stronghold           º
echo.º                             º
echo º 9) Skill Plot               º
echo.º                             º
echo º 10) RealmBank               º
echo.º                             º
echo º 11) Quest Hall              º
echo.º                             º
echo º 97) Your Inventory          º
...
echo º Health: %hp%					 º
echo º Level: %curlvl%					 º
echo º Gold: %money%					 º
echo º EXP: %playerxp%					 º
echo º EXP until next level: %xpuntil%			 º
echo º Total level: %ttllvl%				 º
echo º Weapon: %swordtype% %skind%		 	 º
echo º Armor: %armtype% Armor			 	 º
echo ÌÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍËÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ¹
echo º Items:	       º
echo º Bait: %bait%	       º Gemstones: %gem%
echo º Seeds: %seed%	       º Magic Orbs: %morb%
echo º Furs: %fur%	       º Raw Food: %rfood%
echo º Ore: %ore%	       º Huge Bones: %hbone%
echo º Logs: %log%	       º Dragon Hides: %dhide%
echo º Food: %food%	       º Runic Tablets: %rtab%
echo º Ingots: %ingot%	       º Goblin Mails: %gmail%
echo º Potions: %potion%	       º Bows: %bow%
echo ÌÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÎÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ¹
echo º Weapons:             º Armor:
echo º Wooden Sword: %sword1%      º Cloth Armor: %arm1%
echo º Stone Sword: %sword2%       º Chain Armor: %arm2%
echo º Bronze Sword: %sword3%      º Bronze Armor: %arm3%
echo º Iron Sword: %sword4%        º Iron Armor: %arm4%
echo º Steel Sword: %sword5%       º Steel Armor: %arm5%
echo º Gold Sword: %sword6%        º Gold Armor: %arm6%
echo º Crystal Sword: %sword7%     º Crystal Armor: %arm7%
echo º Sacred Blade: %sword8%      º Sacred Armor: %arm8%
echo º Runic Sword: %sword9%       º Runic Armor: %arm9%
echo º Infernal Rapier: %sword10%   º Infernal Armor: %arm10%
echo º Omega Maul: %sword11%        º Omega Armor: %arm11%
echo º Chaotic Spear: %sword12%     º Chaotic Armor: %arm12%
echo º Mythical Godsword: %ls1% º Mythical Armor: %la1%
echo º Alydril Godsword: %ls2%  º Alydril Armor: %la2%
echo ÈÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ¼
echo.
echo What would you like to do?
echo.
...
echo º You currently have %money% gold. º
echo ÈÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ¼
echo.
echo.
echo ÉÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ»
echo º 1) Mythical Godsword:  Costs 50 Magic Orbs.  º
echo.º		    	 Owned: %ls1%              º
echo.º                                              º
echo º 2) Alydril Godsword:   Costs 100 Magic Orbs. º
echo.º		    	 Owned: %ls2%              º
echo.º                                              º
echo º 3) Mythical Armor:	 Costs 65 Magic Orbs.  º
echo.º		         Owned: %la1%              º
echo.º                                              º
echo º 4) Alydril Armor:   	 Costs 120 Magic Orbs. º
echo.º		   	 Owned: %la2%              º
